<?php
    ...
    {
        //echo $row['Field']."<br>";
        echo '<input onClick="this.select();" type=text name="' . $row['Field'] . '" value="' . $row['Field'] . '"><br>';
    }
                        ...
                        <table width=100% height=95% bgcolor=blue>
                            <tr height=95% style="height:95%">
                                <td valign=top bgcolor="#ffaaff" style="height:95%">
                                    ...
                                    <input onClick="this.select(); type=text name="Name" placeholder="Paste URL -or- Search">
