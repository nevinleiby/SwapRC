<?php
   ...
   // {
        ...
        while (1)
        {
            ...
            {
                echo 'name=('. $item . ')|  value=|' . $_POST[$item] . '|| [';
                echo $connection->real_escape_string($_POST[$item]);
                echo "]<br>";
            }
            break;
        }
   ...
   echo "id name=id value=(" . $_POST[id] . ")<br>\n";
   echo "id name=frame_size value=(" . $_POST[frame_size] . ")<br>\n";
