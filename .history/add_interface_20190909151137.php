    ...
    function q_add_item_to_table ($table_name, &$categories, &$parameters)
    {
        ...
        switch ($table_name)
        {
            case 'fc':
                ...
                $parameters['processor'] =      &check_id($parameters['processor']);
                $parameters['gyro'] =           &check_id($parameters['gyro']);
                $parameters['mounting_holes'] =      &check_id($parameters['mounting_holes']);
                $parameters['osd'] =      &check_id($parameters['osd']);
                $parameters['voltage_min'] =      &check_id($parameters['voltage_min']);
                $parameters['voltage_max'] =      &check_id($parameters['voltage_max']);
                $parameters['firmware'] =      &check_id($parameters['firmware']);
                $parameters['voltage_control'] =      &check_id($parameters['voltage_control']);
                $parameters['antenna_connector'] =      &check_id($parameters['antenna_connector']);
                $parameters['operating_voltage'] =      &check_id($parameters['operating_voltage']);
                
                
                $SQL_STRING = "INSERT INTO '$table_name' (";
                    $SQL_STRING .= " id, processor, ygro, mounting_holes,osd,voltage_min,voltage_max,firmware,voltage_control,antenna_connector,operating_voltage";
                    $SQL_STRING .= " VALUES (";
