<?php
    ...
    $id_query = "SELECT id from $table_name;";
    ...
    for ($j = 0; $j < $rows; ++$j)
    {
        ...
        $row = $display_result->fetch_array(MYSQL_NUM);
        ...
        echo "# $j -" . '<a href="./display_item_old.php?' . $table_name . '=' . $row['id'] . '&category=' . $table_name .'">ITEM=(' . $row['id'] . ')</a>[' . $table_name . ']<br>';
