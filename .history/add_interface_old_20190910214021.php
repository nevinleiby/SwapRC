<?php
    ...
    $id_query = "SELECT id,type1,url_distributor1 from $table_name;";
    ...
    for ($j = 0; $j < $rows; ++$j)
    {
        ...
        echo "# $j -" . '<a href="./display_item_old.php?' . $table_name . '=' . $row['id'] . '&category=' . $table_name .'">ITEM=(' . $row['type1'] . ')</a>[<a href="' . $row['url_distributor1'] . '">link</a>]<br>';
